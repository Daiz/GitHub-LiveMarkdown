...
// ==/UserScript==
(function(){
  require=(function(e,t,n){function i(n,s){if(!t[n]){if(!e[n]){var o=typeof require=="function"&&require;if(!s&&o)return o(n,!0);if(r)return r(n,!0);throw new Error("Cannot find module '"+n+"'")}var u=t[n]={exports:{}};e[n][0].call(u.exports,function(t){var r=e[n][1][t];return i(r?r:t)},u,u.exports)}return t[n].exports}var r=typeof require=="function"&&require;for(var s=0;s<n.length;s++)i(n[s]);return i})({"marked":[function(require,module,exports){
module.exports=require('Kno/1M');
},{}],"Kno/1M":[function(require,module,exports){
(function(global){/**
...
module.exports=require('LF6iI3');
},{}],"LF6iI3":[function(require,module,exports){
...
},{"./brainfuck.js":1,"./cs.js":2,"./erlang.js":3,"./bash.js":4,"./diff.js":5,"./rust.js":6,"./ruby.js":7,"./rib.js":8,"./glsl.js":9,"./lua.js":10,"./lisp.js":11,"./rsl.js":12,"./javascript.js":13,"./xml.js":14,"./markdown.js":15,"./http.js":16,"./css.js":17,"./profile.js":18,"./java.js":19,"./php.js":20,"./haskell.js":21,"./actionscript.js":22,"./1c.js":23,"./smalltalk.js":24,"./python.js":25,"./tex.js":26,"./sql.js":27,"./vala.js":28,"./ini.js":29,"./objectivec.js":30,"./axapta.js":31,"./scala.js":32,"./d.js":33,"./perl.js":34,"./cmake.js":35,"./coffeescript.js":36,"./erlang-repl.js":37,"./avrasm.js":38,"./vhdl.js":39,"./nginx.js":40,"./django.js":41,"./r.js":42,"./delphi.js":43,"./applescript.js":44,"./json.js":45,"./mel.js":46,"./vbscript.js":47,"./dos.js":48,"./apache.js":49,"./cpp.js":50,"./go.js":51,"./parser3.js":52,"./matlab.js":53,"./clojure.js":54}],3:[function(require,module,exports){
  ...
  linkify = {
    ...
    issue: function(text, context, ret){
      ...
      return iterator(text, regex, function(it){
        ...
        case !(user && repo && url):
          if (user !== ctxUser && repo === ctxRepo) {
            return "[" + user + "#" + number + "](/" + user + "/" + repo + "/issues/" + number + ")";
          } else {
            return "[#" + number + "](/" + user + "/" + repo + "/issues/" + number + ")";
          }
          break;
        case !(user && repo && !url):
          return "[" + user + "/" + repo + "#" + number + "](/" + user + "/" + repo + "/issues/" + number + ")";
        case !(!user && !repo):
          return "[#" + number + "](/" + context + "/issues/" + number + ")";
        default:
          return matched;
        }
      });
...
showPreview == null && (showPreview = 'true');
showPreview = showPreview === 'true' ? true : false;
togglePreview = function(it){
  var text;
  it.preventDefault();
  showPreview = !showPreview;
  localStorage.setItem('LiveMarkdownPreview', showPreview);
  if (showPreview) {
    previewBucket.classList.remove('preview-hidden');
    text = textarea.value || 'Nothing to preview';
    preview.innerHTML = format(text);
  } else {
    previewBucket.classList.add('preview-hidden');
  }
};
content = d.querySelector('.write-content');
textarea = content.querySelector('textarea');
head = d.head;
x$ = button = d.createElement('a');
...
z$.className = 'live-preview-styling';
z$.textContent = '@font-face{font-family:LivePreviewIcon;src:url(data:application/x-font-woff;base64,) format("woff");font-weight:400;font-style:normal}.octicon-live-preview:before{font-family:LivePreviewIcon;content:"!";font-size:13px}.write-content .js-toggle-live-preview{position:absolute;top:4px;right:36px;color:#333;opacity:.5;line-height:1em}.js-toggle-live-preview:hover{opacity:1}.write-content .comment{margin-top:8px}.preview-hidden{display:none}';
z1$ = cssPre = d.createElement('style');
z1$.className = 'live-preview-code-styling';
z1$.textContent = 'pre code{display:block;padding:.5em;color:#333;background:#f8f8ff}pre .comment,pre .template_comment,pre .diff .header,pre .javadoc{color:#998;font-style:italic}pre .keyword,pre .css .rule .keyword,pre .winutils,pre .javascript .title,pre .nginx .title,pre .subst,pre .request,pre .status{color:#333;font-weight:700}pre .number,pre .hexcolor,pre .ruby .constant{color:#099}pre .string,pre .tag .value,pre .phpdoc,pre .tex .formula{color:#d14}pre .title,pre .id{color:#900;font-weight:700}pre .javascript .title,pre .lisp .title,pre .clojure .title,pre .subst{font-weight:400}pre .class .title,pre .haskell .type,pre .vhdl .literal,pre .tex .command{color:#458;font-weight:700}pre .tag,pre .tag .title,pre .rules .property,pre .django .tag .keyword{color:navy;font-weight:400}pre .attribute,pre .variable,pre .lisp .body{color:teal}pre .regexp{color:#009926}pre .class{color:#458;font-weight:700}pre .symbol,pre .ruby .symbol .string,pre .lisp .keyword,pre .tex .special,pre .prompt{color:#990073}pre .built_in,pre .lisp .title,pre .clojure .built_in{color:#0086b3}pre .preprocessor,pre .pi,pre .doctype,pre .shebang,pre .cdata{color:#999;font-weight:700}pre .deletion{background:#fdd}pre .addition{background:#dfd}pre .diff .change{background:#0086b3}pre .chunk{color:#aaa}';
z2$ = js = d.createElement('script');
z2$.src = 'https://gist.github.com/Daiz-/0146e783887fea4c462d/raw/fea70365ef1281e09959914a8c765efb2d5a1db8/embed.js';
z3$ = head;
z3$.appendChild(css);
z3$.appendChild(cssPre);
button.appendChild(icon);
content.insertBefore(button, content.firstChild);
d.body.appendChild(js);
previewBucket = d.querySelector('.preview-content').childNodes[1].cloneNode(true);
preview = previewBucket.querySelector('.comment-body');
if (!showPreview) {
  previewBucket.classList.add('preview-hidden');
}
content.appendChild(previewBucket);
